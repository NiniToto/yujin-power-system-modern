...
const categoryData = {
    ...
    products: [
        { id: 'p301', name: '커스텀 밸브 시스템', image: '/asset/images/product1.png' },
        { id: 'p302', name: '정밀 기계 부품', image: '/asset/images/product2.png' },
        { id: 'p303', name: '제어 시스템 모듈', image: '/asset/images/product3.png' },
        { id: 'p304', name: '특수 센서 어셈블리', image: '/asset/images/product4.png' },
        { id: 'p305', name: '고내구성 커넥터 시스템', image: '/asset/images/product5.png' },
        { id: 'p306', name: '맞춤형 PCB 설계', image: '/asset/images/product5.png' },
    ]
};
                                ...
                                {categoryData.products.map((product, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="p-4">
                                            ...
                                            <Link
                                                href={`/product/category3/${product.id}`}
