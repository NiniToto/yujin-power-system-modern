...
const categoryData = {
    ...
    products: [
        { id: 'p201', name: '산업용 제어 장비', image: '/asset/images/product1.png' },
        { id: 'p202', name: '자동화 컨트롤러', image: '/asset/images/product2.png' },
        { id: 'p203', name: '센서 네트워크 시스템', image: '/asset/images/product3.png' },
        { id: 'p204', name: '모션 제어 시스템', image: '/asset/images/product4.png' },
        { id: 'p205', name: '로봇 자동화 솔루션', image: '/asset/images/product5.png' },
        { id: 'p206', name: '비전 검사 시스템', image: '/asset/images/product5.png' },
      ]
};
                                ...
                                {categoryData.products.map((product, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="p-4">
                                            ...
                                            <Link
                                                href={`/product/category2/${product.id}`}
