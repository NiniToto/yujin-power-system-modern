...
const categoryData = {
    ...
    products: [
        { id: 'p501', name: '다기능 측정기', image: '/asset/images/product1.png' },
        { id: 'p502', name: '공장용 조명 시스템', image: '/asset/images/product2.png' },
        { id: 'p503', name: '모듈형 배전함', image: '/asset/images/product3.png' },
        { id: 'p504', name: '휴대용 테스터기', image: '/asset/images/product4.png' },
        { id: 'p505', name: '산업용 네트워크 장비', image: '/asset/images/product5.png' },
        { id: 'p506', name: '기타 맞춤형 부품', image: '/asset/images/product5.png' },
    ]
};
...
export default function ProductCategory5Page() {
    return (
        <>
            {/* 페이지 헤더 */}
                                ...
                                {categoryData.products.map((product, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="p-4">
                                            ...
                                            <Link
                                                href={`/product/category5/${product.id}`}
                                                className="mt-2 w-full bg-gray-50 hover:bg-gray-100 text-gray-700 py-2 rounded-md text-sm transition-colors flex items-center justify-center"
                                            >
                                                <span>상세 정보</span>
